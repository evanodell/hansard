...
Note that the API defaults to returning 10 items per page, but allows up to 500 items per page. All `hansard` functions, with the exception of `hansard_generic`, return 500 items per page, and bind pages together if more than 500 items are retrieved.
