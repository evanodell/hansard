...
mp_questions <- function(mp_id, question_type = c("all", "oral", "written")) {
    ...
    if (question_type == "all") {
        ...
        oral <- jsonlite::fromJSON(paste0(baseurl_oral, mp_id, "&_pageSize=500"))
        ...
        for (i in 0:oralJpage) {
            mydata <- jsonlite::fromJSON(paste0(baseurl_oral, mp_id, "&_pageSize=500&_page=", i), flatten = TRUE)
        ...
        writ <- jsonlite::fromJSON(paste0(baseurl, mp_id, "&_pageSize=500"))
        ...
        for (i in 0:jpage) {
            mydata <- jsonlite::fromJSON(paste0(baseurl, mp_id, "&_pageSize=500&_page=", i), flatten = TRUE)
