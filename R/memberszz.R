...
#' Returns a list of data frames, each details on the registered interests of a member of the House of Lords
#'



memberszz <- function(house=c("all","commons","commons interests",
